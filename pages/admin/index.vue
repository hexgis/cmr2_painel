  ...
  <div class="admin pa-5">
    ...
    <v-row>
      <v-col>
        <v-card
          class="pa-5 d-flex"
          :to="localePath('/views-chart')"
        >
          <div class="card--wrapper">
            <p class="font-weight-bold text-h6">
              {{ $t("acess-total", { acessTotal }) }}
            </p>
            <p class="text-h6">
              {{ $t("year", { currentYear }) }}
            </p>
    ...
    <v-row>
      <v-card
        class="banner"
        @click.prevent="goToRescrictedArea"
      >
        <span id="circle">
        ...
        <div class="banner--content pl-2">
          <p class="mb-0 text-h6">
            <strong>{{ $t("new-requests") }} </strong>{{ $t("restricted-area-access") }}
          </p>
    ...
    <v-row>
      <v-card
        class="ma-2 pt-2 pl-4 d-flex"
        style="width: 100%;"
        @click.prevent="goToHandleUsers"
      >
        <v-col
          class="w-40"
          style="max-width: 40%;"
